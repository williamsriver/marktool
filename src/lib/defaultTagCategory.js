    ...
    "tags":[
      ...
      },
      {
        ...
        "description":{
          ...
          ,
          "ch":
            "功能完整性：功能集涵盖所有指定任务和用户目标的程度。\n" +
            "功能正确性：功能以所需的精确度提供正确结果的程度。\n" +
            "功能适当性：功能在多大程度上促进了特定任务和目标的完成。"
        }
      },
      {
        ...
        "description":{
          "en":"Time-behavior: degree to which the response and processing times and" +
            ...
            "Capacity: degree to which the maximum limits of the product or system," +
            " parameter meet requirements."
          ,
          "ch":
            "时间行为：产品或系统在执行其功能时，其响应和处理时间以及吞吐率达到要求的程度。\n" +
            "资源利用率：产品或系统在执行其功能时所使用的资源数量和类型满足要求的程度。\n" +
            "容量：产品或系统的最大限制，参数满足要求的程度。"
        }
      },
      {
        "value": "Compatibility",
        ...
        "description":{
          "en":
            "Coexistence: degree to which a product can perform its required functions" +
          ...
          ,
          "ch":
            "共存：产品可以有效地执行其所需功能的程度，同时与其他产品共享共同的环境和资源，而不会对任何其他产品造成不利影响。\n" +
            "互操作性：两个或更多系统，产品或组件可以交换信息并使用已交换的信息的程度。"
      ...
      },
      {
        ...
        "description": {
          "en":
            "Appropriateness recognisability: degree to which users can recognize whether a product" +
            "or system is appropriate for their needs. \n" +
            "Learnability: degree to which a product or system enables the user to learn how to use it" +
            "with effectiveness, efficiency in emergency situations. \n" +
            "Operability: degree to which a product or system is easy to operate, control and" +
            " appropriate to use. \n" +
          ...
          "ch":
            ...
            "可学习性：产品或系统使用户能够学习如何在紧急情况下有效，高效地使用产品的程度。\n" +
            "可操作性：产品或系统易于操作，控制和适当使用的程度。\n" +
            "用户错误保护：产品或系统保护用户避免错误的程度。\n" +
            "用户界面美学：用户界面为用户带来令人愉悦和令人满意的交互的程度。\n" +
            "可访问性：具有最广泛的特征和能力的人员可以在特定的使用上下文中使用产品或系统以达到特定目标的程度。"
        }
      },
      {
        "value": "Security",
        ...
        "description": {
          "en":
            "Confidentiality: degree to which the prototype ensures that data are accessible only" +
          ...
          ,
          "ch":
            "机密性：原型确保只有授权访问的人才能访问数据的程度。\n" +
            "完整性：系统，产品或组件防止未经授权访问或修改计算机程序或数据的程度。\n" +
            "不可抵赖性：可以证明已发生某种动作或事件的程度，因此以后无法否认这些事件或动作。\n" +
            "问责制：可以将实体的行为唯一地追溯到实体的程度。\n" +
            "真实性：主题或资源的身份可被证明是所主张的程度。"
        }
      },
      {
        "value": "Reliability",
        ...
        "description": {
          "en":
            ...
            "Recoverability: degree to which, in the event of an interruption or a failure," +
            "a product or system can recover the data directly affected and re-establish the desired state of the system."
          ,
          "ch":
            "成熟度：系统，产品或组件在正常操作下满足可靠性需求的程度。\n" +
            "可用性：产品或系统在需要使用时可操作和可访问的程度。\n" +
            "容错能力：尽管存在硬件或软件故障，系统，产品或组件按预期运行的程度。\n" +
            "可恢复性：在发生中断或故障时，产品或系统可以恢复直接受影响的数据并重新建立系统所需状态的程度。"
        }
      },
      {
        ...
        "description": {
          "en":
            ...
            "Analyzability: degree of effectiveness and efficiency with which" +
          ...
          "ch":
            "模块化：系统或计算机程序由离散组件组成的程度，以使对一个组件的更改对其他组件的影响最小。\n" +
            "可重用性：资产可在多个系统中或在构建其他资产中使用的程度。\n" +
            "可分析性：有效性和效率的程度，可以用来评估对产品或系统的一个或多个零件的预期更改的影响" +
            "，或诊断产品的缺陷或故障原因，或识别零件 被修改.\n" +
            "可修改性：在不引入缺陷或不降低现有产品质量的情况下，可以有效，高效地修改产品或系统的程度。\n" +
            "可测试性：可以为系统，产品或组件建立测试标准并进行测试以确定是否满足这些标准的有效性和效率程度."
        }
      },
      {
        "value": "Portability",
        ...
        "description": {
          "en":
            ...
            "Installability: degree of effectiveness and efficiency in" +
            "which a product or system can be successfully installed and/or uninstalled in a specified environment.\n" +
          ...
          "ch":
            ...
            "可安装性：在指定环境中可以成功安装和/或卸载产品或系统的有效性和效率。 \n" +
            "可替换性：产品可以在同一环境中出于相同目的替换另一指定软件产品的程度。"
        }
      },
      {
        "value": "Bug_Fix",
