  ...
  export default {
    ...
    methods: {
      ...
      getcmt(comment_id){
        ...
        this.axios.get('tonycoder.ziqiang.net.cn:8080/comments/',config1)
          .then(function (response) {
            ...
            for (var i=0;i<this.current_tag_id_list.length;i++) {
              if (this.current_tag_id_list[i]){
                this.axios.get('tonycoder.ziqiang.net.cn:8080/tag/', {params: {tag_id: this.current_tag_id_list[i]}})
                  .then(function (response) {
      ...
      saveMark(key) {
        ...
        if (this.current_tag === "") {
          this.axios.post('tonycoder.ziqiang.net.cn:8080/tag/', formData1)
            .then(function (response) {
              console.log(response)
          ...
          this.axios.put('tonycoder.ziqiang.net.cn:8080/tag/', formData2)
            .then(function (response) {
              console.log(response)
              if (response.data.Msg === "OK") {
                this.issave = true;
