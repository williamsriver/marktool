    ...
    export default {
      ...
      methods:{
        ...
        loginadmit(){
          ...
          this.axios.post('localhost:8080/login/',formData1)
        ...
        //get comment lists
        getLists(){
          this.axios.get('localhost:8080/commentsList/',{params:{username:this.$store.state.currentuser} })
            .then(function (response) {
        ...
        getCommentListByList(listid){
          this.axios.get('localhost:8080/commentsList/',{params:{list_id:listid} })
            .then(function (response) {
        ...
        getcmt(cmtid){
          var flag1 =false
          this.comment_need++;
          this.axios.get('localhost:8080/comments/',{params:{comment_id:cmtid} })
            .then(function (response) {
        ...
        uploadExcel(event){
          ...
          this.axios.post('localhost:8080/fileoperations/',formData1)
            .then(function (response) {
              console.log(response)
